...
//            if(returnnondomestic.equals("")){returnnondomestic="0";}
            String name="",fourteen="",nineteen="",five="",defective="",type="",fourteen_price="",nineteen_price="",five_price="";
            String returndefective ="" ,sql="",returnfourteenempty ="" ,returnnineteenempty="" ,returnfiveempty ="";
...
//          setting values to 0
            ...
            sql="insert into factory(drivername,fourteen,fourteen_price,nineteen,nineteen_price,five,five_price,defective,type,returndomesticempty,returnnondomesticempty,returnfiveempty,returndefective,day)values('"+name+"','"+fourteen+"','"+fourteen_price+"','"+nineteen+"','"+nineteen_price+"','"+five+"','"+five_price+"','"+defective+"','"+type+"','"+returnfourteenempty+"','"+returnnineteenempty+"','"+returnfiveempty+"','"+returndefective+"','"+today+"')";
            ...
            sql = "update godown set filled_fourteen ='"+four+"',filled_nineteen='"+nine+"',filled_five='"+f5+"',filled_defective='"+defect+"',empty_five='"+returnf5+"',empty_fourteen='"+returnfour+"',empty_nineteen='"+returnnine+"',empty_defective='"+returndefect+"', day='"+today+"' where id ="+1;
            db.conn.createStatement();
            db.st.executeUpdate(sql);
