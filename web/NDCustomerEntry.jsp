...
<html>
    ...
    <body>
        <%
            ...
            finalamt += diffamt;
            finalcv += diffcv;
             sql="insert into nondomestic (name,filled,empty,amount,amountpaid,osamt,cvdue,transaction,daytoday,phno)values('"+name+"','"+filledcc+"','"+emptycc+"','"+amount+"','"+amtpaid+"','"+diffamt+"','"+diffcv+"','"+transaction+"','"+tod+"','"+phno+"')";
